...
namespace planTopia.Enemies
{
    public class BossAI : MonoBehaviour
    {
        ...
        [SerializeField] [Range(1, 10)] private float healthIncrease = 2f;
        [SerializeField] [Range(1, 10)] private float timeHealthIncrease = 3;
        ...
        [SerializeField] private float phase2Speed = 1f;
